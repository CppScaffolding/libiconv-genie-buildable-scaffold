# -----------------------------------------------------------------------------
# DEPS file for libiconv-genie-buildable scaffold
# =========================================
# -----------------------------------------------------------------------------

# This file is used to manage the dependencies of the
# libiconv-genie-buildable-scaffold scaffold repo.
...
vars = {
  ...
  # this
  # line
  'libiconv-genie-buildable_revision': '',
  # keep
  # this
  # line
  # ---------------------------------------------------------------------------
...
deps = {
  ...
  # this
  # line
  'libiconv-genie-buildable': 'https://github.com/KageKirin/libiconv-genie-buildable.git@{libiconv-genie-buildable_revision}',
  # keep
  # this
  # line
}
